...
tables_path="$current_path/exome_pre_loaded_tables_Chr17_Chr18_Chr19_Chr20"
echo $tables_path
...
# run_sample6_wrapper.sh
sed -e s,sample_path,"$sample_path",g < "$template_pwd/run_sample6_wrapper.sh" > "$sample_path/run_cnv_wrapper_$sample_name.sh"
...
-e s,code_path,"$current_path",g -e s,seq_db,"$seq_db",g < "$template_pwd/run_sample6.sh" > "$sample_path/run_cnv_$sample_name.sh"
...
-e s,scripts_location,"$scripts_location",g -e s,socket_path,"$socket_path",g -e s,dbname\=\"cnv\","$dbg6",g \
...
# create_tables_ref.R                                                                                                                                        
sed -e s,sample_path,"$sample_path",g -e s,sample_name,"$sample_name",g -e s,control_name,"$control_name",g -e s,dbname\=\"cnv\","$dbg6",g \
...
#cp $template_pwd/chr17_chr18_chr19_chr20_ordered_genes.txt $sample_path/ordered_genes.txt
echo "Searching chr17-20 genes"
mv $sample_path/ordered_genes.txt $sample_path/ordered_genes.txt.orig
perl $scripts_location/find_chr17_18_19_20.pl $template_pwd/TSOV2supp_genes_chr_listed $sample_path/ordered_genes.txt.orig
cp $current_path/chr17_18_19_20_genes_file.txt $sample_path/ordered_genes.txt
...
-e s,socket_path,"$socket_path",g -e s,tables_path,"$tables_path",g -e s,dbname\=\"cnv\","$dbg6",g \
...
# plot_genes_ordered_cnv6.py                                                                
sed -e s,sample_path,"$sample_path",g -e s,scripts_location,"$scripts_location",g \
-e s,socket_path,"$socket_path",g -e s,tables_path,"$tables_path",g \
< "$template_pwd/plot_genes_ordered_cnv6.py" > "$sample_path/plot_genes_ordered_cnv6.py"
