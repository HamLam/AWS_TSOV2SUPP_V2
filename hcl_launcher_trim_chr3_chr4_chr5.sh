...
tables_path="$current_path/exome_pre_loaded_tables_Chr3_Chr4_Chr5"
echo $tables_path
...
# run_sample2_wrapper.sh
sed -e s,sample_path,"$sample_path",g < "$template_pwd/run_sample2_wrapper.sh" > "$sample_path/run_cnv_wrapper_$sample_name.sh"
...
-e s,code_path,"$current_path",g -e s,seq_db,"$seq_db",g < "$template_pwd/run_sample2.sh" > "$sample_path/run_cnv_$sample_name.sh"
...
# create_reference_g2.sql
sed -e s,control_name,"$control_name",g -e s,sample_name,"$sample_name",g < "$template_pwd/create_reference_g2.sql" > "$sample_path/create_reference_g2.sql"

# find_median.R
sed -e s,sample_path,"$sample_path",g -e s,sample_name,"$sample_name",g -e s,control_name,"$control_name",g \
-e s,scripts_location,"$scripts_location",g -e s,socket_path,"$socket_path",g -e s,dbname\=\"cnv\","$dbg2",g \
...
# create_tables_ref.R                                                                                                                                        
sed -e s,sample_path,"$sample_path",g -e s,sample_name,"$sample_name",g -e s,control_name,"$control_name",g -e s,dbname\=\"cnv\","$dbg2",g \
...
-e s,socket_path,"$socket_path",g -e s,tables_path,"$tables_path",g -e s,dbname\=\"cnv\","$dbg2",g \
...
# plot_genes_ordered_cnv2.py                                                                
sed -e s,sample_path,"$sample_path",g -e s,scripts_location,"$scripts_location",g \
-e s,socket_path,"$socket_path",g -e s,tables_path,"$tables_path",g \
< "$template_pwd/plot_genes_ordered_cnv2.py" > "$sample_path/plot_genes_ordered_cnv2.py"
