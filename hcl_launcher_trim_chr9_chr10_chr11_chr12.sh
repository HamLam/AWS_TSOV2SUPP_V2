...
tables_path="$current_path/exome_pre_loaded_tables_Chr9_Chr10_Chr11_Chr12"
echo $tables_path
...
# run_sample4_wrapper.sh
sed -e s,sample_path,"$sample_path",g < "$template_pwd/run_sample4_wrapper.sh" > "$sample_path/run_cnv_wrapper_$sample_name.sh"
...
-e s,code_path,"$current_path",g -e s,seq_db,"$seq_db",g < "$template_pwd/run_sample4.sh" > "$sample_path/run_cnv_$sample_name.sh"
...
# create_tables_ref.R                                                                                                                                        
sed -e s,sample_path,"$sample_path",g -e s,sample_name,"$sample_name",g -e s,control_name,"$control_name",g -e s,dbname\=\"cnv\","$dbg4",g \
...
perl $scripts_location/find_chr9_10_11_12.pl $template_pwd/TSOV2supp_genes_chr_listed $sample_path/ordered_genes.txt.orig
cp $current_path/chr9_10_11_12_genes_file.txt $sample_path/ordered_genes.txt
cp $current_path/chr9_10_11_12_genes_file.txt $sample_path/chr9_10_11_12_genes_file.txt
...
# plot_genes_ordered_cnv4.py                                                                
sed -e s,sample_path,"$sample_path",g -e s,scripts_location,"$scripts_location",g \
-e s,socket_path,"$socket_path",g -e s,tables_path,"$tables_path",g -e s,dbname\=\"cnv\","$dbg4",g \
< "$template_pwd/plot_genes_ordered_cnv4.py" > "$sample_path/plot_genes_ordered_cnv4.py"
